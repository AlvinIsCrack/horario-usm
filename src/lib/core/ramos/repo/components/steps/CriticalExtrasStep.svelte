<script lang="ts">
	...
	import MingcuteFolderDeleteFill from '$lib/icons/MingcuteFolderDeleteFill.svelte';
	...
	import TablerPuzzle from '$lib/icons/TablerPuzzle.svelte';
	import TablerPuzzleFilled from '$lib/icons/TablerPuzzleFilled.svelte';
